...
<html lang="en">
    <head>
        ...
        <link href="${resource(file: 'libs/bootstrap/css/bootstrap.css', plugin: 'admin')}" rel="stylesheet" />
        <link href="${resource(file: 'libs/bootstrap/css/bootstrap-theme.css', plugin: 'admin')}" rel="stylesheet" />
    ...
    <body>
        ...
        <script src="${resource(file: 'libs/jquery/jquery.js', plugin: 'admin')}"></script>
        <script src="${resource(file: 'libs/bootstrap/js/bootstrap.js', plugin: 'admin')}"></script>
        ...
        <script src="${resource(file: 'libs/parsleyjs/parsley.remote.js', plugin: 'admin')}"></script>
